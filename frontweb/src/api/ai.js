...
export const aiAPI = {
  list(serviceType, options = {}) {
    const params = { ...(serviceType ? { service_type: serviceType } : {}), ...(options.tenantId ? { tenant_id: options.tenantId } : {}), ...(options.selectable ? { selectable: true } : {}), ...(options.platform ? { platform: true } : {}) }
