<template>
  <figure class="operations-trend" aria-labelledby="operations-trend-title">
    <figcaption><div><p>近七日生产</p><h3 id="operations-trend-title">创建与完成趋势</h3></div></figcaption>
    <div ref="chartElement" class="operations-echart" role="img" :aria-label="'近七日创建与完成趋势图'"></div>
...
watch(items, async () => { await nextTick(); renderChart() })
