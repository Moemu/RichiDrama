...
<style scoped>
.tool-asset-selector{display:grid;gap:8px}.selector-heading{display:flex;align-items:center;justify-content:space-between;gap:8px}.selector-heading b{font-size:12px}.asset-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;max-height:160px;overflow:auto}.asset-grid button{min-width:0;padding:4px;border:1px solid var(--tool-asset-border,#d4d4d4);border-radius:5px;background:var(--tool-asset-bg,#fff);text-align:left;cursor:pointer}.asset-grid button.active{border-color:var(--tool-asset-active,#171717);box-shadow:inset 2px 0 0 var(--tool-asset-active,#171717)}.asset-grid img,.asset-grid video,.asset-grid span{display:grid;place-items:center;width:100%;height:52px;object-fit:cover;background:var(--tool-asset-media,#f5f5f5);color:var(--tool-asset-muted,#525252)}.asset-grid small{display:block;padding-top:4px;overflow:hidden;color:var(--tool-asset-muted,#525252);font-size:10px;text-overflow:ellipsis;white-space:nowrap}.empty,.upload-note,.selected{margin:0;color:var(--tool-asset-muted,#737373);font-size:11px;line-height:1.45}.selected{color:var(--tool-asset-text,#262626);font-weight:600}
</style>
