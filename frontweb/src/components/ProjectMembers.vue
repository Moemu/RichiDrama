<template>
  <section class="project-members">
    <div class="members-heading"><h2>项目成员</h2><el-button v-if="permissions.can_manage && !permissions.collaboration_enabled" :loading="busy" @click="enable">启用共同编辑</el-button></div>
