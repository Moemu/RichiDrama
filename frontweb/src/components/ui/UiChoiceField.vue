<template>
  <section class="ui-choice-field" :class="{ 'is-open': open, 'is-disabled': disabled, 'is-invalid': invalid }">
    ...
    <small v-if="error" :id="errorId" class="ui-choice-field__error" role="alert">{{ error }}</small>
