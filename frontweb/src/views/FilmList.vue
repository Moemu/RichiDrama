...
.logo{position:relative;min-width:146px}
...
@media(max-width:760px){.header-inner{gap:6px}.logo{min-width:0}.richi-brand-mark{width:30px;height:30px;flex-basis:30px}.richi-brand-copy{display:none}.header-actions{gap:4px;overflow:hidden}.header-actions :deep(.account-balance){display:none}.header-actions .btn-new{margin-left:0;padding-inline:12px}.header-more .btn-more{padding-inline:8px}}
