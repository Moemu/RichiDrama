...
@media(min-width:900px){
  ...
  .section-title{display:flex;align-items:center;gap:10px;margin-bottom:24px;font-size:1.25rem;font-weight:740}.main > .section.card:first-child .section-title::before,.main > .section.card:nth-child(2) .section-title::before,.main > .section.card:nth-child(3) .section-title::before{font-size:10px;font-weight:800;letter-spacing:.16em;color:var(--accent);white-space:nowrap}.main > .section.card:first-child .section-title::before{content:'PROJECT BRIEF'}.main > .section.card:nth-child(2) .section-title::before{content:'EPISODE QUEUE'}.main > .section.card:nth-child(3) .section-title::before{content:'ASSET LIBRARY'}
