...
/* 浅色主题下统一项目工作流的底色与层级，避免旧页面深色样式与资源/分镜工作台冲突。 */
:global(html.light) .film-create{background:#f6f4f0!important;color:#302b25!important}
:global(html.light) .film-create .header{background:#fffdfa!important;border-color:#e3ddd5!important;box-shadow:0 1px 6px #3d30200d!important}
:global(html.light) .film-create .logo-main{color:#2d2924!important;-webkit-text-fill-color:#2d2924!important}
:global(html.light) .film-create .logo-sub,:global(html.light) .film-create .page-title{color:#746b61!important;-webkit-text-fill-color:#746b61!important}
:global(html.light) .film-create .btn-theme,:global(html.light) .film-create .btn-ai-config,:global(html.light) .film-create .btn-back-drama{--el-button-bg-color:#fff!important;--el-button-border-color:#ded7ce!important;--el-button-text-color:#443b32!important}
:global(html.light) .film-create :deep(.el-card),:global(html.light) .film-create :deep(.el-collapse),:global(html.light) .film-create :deep(.el-collapse-item__header),:global(html.light) .film-create :deep(.el-collapse-item__wrap){background:#fffdfa!important;border-color:#e3ddd5!important;color:#302b25!important}
:global(html.light) .film-create .workflow-shell,:global(html.light) .film-create .resource-center,:global(html.light) .film-create .storyboard-workbench-toolbar{background:#fffdfa!important;border-color:#e3ddd5!important;box-shadow:0 4px 16px #3d30200a!important}
</style>
