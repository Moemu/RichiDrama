...
:global(html.light) .film-create{background:#10151d!important;color:#f2f0ea!important}
:global(html.light) .film-create .header{background:#181f29!important;border-color:#334050!important;box-shadow:none!important}
:global(html.light) .film-create .logo-main{color:#f2f0ea!important;-webkit-text-fill-color:#f2f0ea!important}
:global(html.light) .film-create .logo-sub,:global(html.light) .film-create .page-title{color:#aab4c0!important;-webkit-text-fill-color:#aab4c0!important}
:global(html.light) .film-create .btn-theme,:global(html.light) .film-create .btn-ai-config,:global(html.light) .film-create .btn-back-drama{--el-button-bg-color:#181f29!important;--el-button-border-color:#405064!important;--el-button-text-color:#dce4eb!important}
:global(html.light) .film-create :deep(.el-card),:global(html.light) .film-create :deep(.el-collapse),:global(html.light) .film-create :deep(.el-collapse-item__header),:global(html.light) .film-create :deep(.el-collapse-item__wrap){background:#181f29!important;border-color:#334050!important;color:#f2f0ea!important}
:global(html.light) .film-create .workflow-shell,:global(html.light) .film-create .resource-center,:global(html.light) .film-create .storyboard-workbench-toolbar{background:#181f29!important;border-color:#334050!important;box-shadow:none!important}
</style>
