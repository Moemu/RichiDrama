  ...
  return {
    ...
    execute:(req,res)=>{
      try {
        ...
        const authorization=billing.createAuthorization(db,req.auth,{idempotency_key:idempotencyKey,service_type:'text',model:billingTarget.billing_key,usage,reference_type:'tool_run',reference_id:dramaId,drama_id:dramaId,source_kind:'tool_run'});
